...
cache_setting = getattr(settings, 'ANSIBLE_BASE_JWT_CACHE_NAME', 'default')
...
class JWTCommonAuth:
    ...
    def get_decryption_key_from_url(self, url: str, timeout: int, validate_certs: bool, ignore_cache: bool) -> Tuple[str, bool]:
    ...
    def get_decryption_key(self, url_or_string: str, ignore_cache: bool = False, **kwargs: dict) -> Tuple[str, bool]:
